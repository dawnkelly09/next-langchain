Pulled this down from GH and built it out along with Developers Digest: https://www.youtube.com/watch?v=qVM2BhAnKqo

Great quick and dirty chatbot starter which can be used with any API call you want to help the agent retrieve info.
